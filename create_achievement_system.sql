...
CREATE TYPE IF NOT EXISTS achievement_category AS ENUM ('trading', 'profit', 'streak', 'special', 'milestone');
...
-- Create RLS policies
CREATE POLICY IF NOT EXISTS "Users can view own achievement progress" ON achievement_progress
  FOR SELECT USING (auth.uid() = user_id);

CREATE POLICY IF NOT EXISTS "Users can update own achievement progress" ON achievement_progress
