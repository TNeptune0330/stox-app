-- Fixed SQL script for Supabase auth trigger
...
-- Create or replace the trigger function (fixed $$ delimiters)
...
-- Create function for login updates (fixed $$ delimiters)
