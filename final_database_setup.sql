...
-- Optimized for the current clean schema (no unused columns)
...
-- Ensure unique progress per user per achievement
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
...
-- ============================================================================
-- 3. POPULATE ACHIEVEMENT METADATA
-- ============================================================================

-- Update existing achievements with proper metadata
UPDATE public.user_achievements SET 
  ...
  icon_name = CASE achievement_id
    ...
    WHEN 'first_trade' THEN '983555'
    WHEN 'ten_trades' THEN '983716'
    WHEN 'hundred_trades' THEN '983858'
    WHEN 'thousand_trades' THEN '57404'
    WHEN 'legendary_trader' THEN '59644'
    -- Milestone achievements
    WHEN 'diversified' THEN '983427'
    WHEN 'portfolio_watcher' THEN '59064'
    WHEN 'market_explorer' THEN '57658'
    WHEN 'master_of_all' THEN '58086'
    -- Profit achievements
    WHEN 'first_profit' THEN '57673'
    WHEN 'big_profit' THEN '57669'
    WHEN 'millionaire' THEN '59644'
    WHEN 'multi_millionaire' THEN '59836'
    WHEN 'billionaire' THEN '57404'
    -- Streak achievements
    WHEN 'winning_streak' THEN '58614'
    WHEN 'marathon_trader' THEN '983325'
    WHEN 'perfectionist' THEN '59836'
    -- Special achievements
    WHEN 'diamond_hands' THEN '983427'
    WHEN 'paper_hands' THEN '58297'
    WHEN 'early_bird' THEN '59991'
    WHEN 'night_owl' THEN '59159'
    WHEN 'weekend_warrior' THEN '59991'
    WHEN 'high_roller' THEN '57427'
    WHEN 'penny_pincher' THEN '58736'
    WHEN 'day_trader' THEN '57404'
    WHEN 'swing_trader' THEN '983858'
    WHEN 'value_investor' THEN '58835'
    ELSE '57404'
  END,
...
-- Update achievement progress completion status
...
-- ============================================================================
-- 4. CLEAN UP OLD ACHIEVEMENTS
-- ============================================================================

-- Remove any old sector-based achievements
...
SELECT 
  COALESCE(achievement_category, 'uncategorized') as category, 
  COUNT(*) as count 
...
-- Next step: Run force_drop_functions.sql then comprehensive_database_fixes.sql 
-- to add the SQL functions for trade counting and achievement management.